 ...
 *     description: Scarica la specifica OpenAPI del servizio notifiche in formato JSON
 *     tags:
 *       - Documentation
 *     responses:
 *       200:
...
app.get('/docs/openapi.json', (req, res) => {
  ...
  res.setHeader('Content-Disposition', 'attachment; filename="notification-service-openapi.json"');
  res.json(specs);
});
 ...
 *     description: Scarica la specifica OpenAPI del servizio notifiche in formato YAML
 *     tags:
 *       - Documentation
 *     responses:
 *       200:
...
app.get('/docs/openapi.yaml', (req, res) => {
  try {
    ...
    res.setHeader('Content-Disposition', 'attachment; filename="notification-service-openapi.yaml"');
    res.send(yamlStr);
  } catch (error) {
